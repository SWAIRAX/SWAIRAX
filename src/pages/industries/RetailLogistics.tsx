      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-r from-red-500 to-pink-600 flex items-center justify-center">
              ...
              return (
                ...
                >
                  <CardContent className="p-8">
                    <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-red-500 to-pink-600 flex items-center justify-center mb-6">
            ...
            {caseStudies.map((study, index) => (
              <Card key={study.title} className="border-0 bg-card">
                <CardContent className="p-8 text-center">
                  ...
                  <div className="text-3xl font-bold text-red-600 mb-4">{study.result}</div>
