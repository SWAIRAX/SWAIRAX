      ...
      <section className="relative py-16 md:py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-10 relative z-10">
          <div className="text-center mb-6 md:mb-8">
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold mb-2 md:mb-3 bg-gradient-to-r from-foreground via-red-500 to-foreground bg-clip-text text-transparent">
          ...
          <div className="max-w-6xl mx-auto">
            <Card className="bg-gradient-to-br from-card to-card/50 border border-border/50 shadow-2xl backdrop-blur-sm hover:shadow-3xl transition-shadow duration-300">
              <CardContent className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
                <div className="text-center mb-4 md:mb-6">
                  <div className="inline-flex items-center gap-2 bg-gradient-to-r from-red-500/10 to-blue-500/10 px-3 py-1 rounded-full mb-3 md:mb-4 border border-red-500/20">
                    <span className="w-2 h-2 bg-red-500 rounded-full animate-pulse"></span>
                    <span className="text-xs font-medium text-red-600">Case Study</span>
                  </div>
                  <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold mb-2 md:mb-3 bg-gradient-to-r from-red-500 to-blue-500 bg-clip-text text-transparent leading-tight">
                    How can we use data to increase revenues?
                  </h3>
                  <p className="text-xs sm:text-sm md:text-base text-muted-foreground px-2 max-w-lg mx-auto leading-relaxed">
                    10 ways we add value to this company through data intelligence.
                  </p>
                </div>

                <div className="mb-6 md:mb-8 p-3 sm:p-4 md:p-6 bg-gradient-to-r from-red-500/10 via-blue-500/10 to-red-500/10 rounded-xl border border-red-500/20 shadow-sm">
                  <p className="text-xs sm:text-sm md:text-base text-foreground leading-relaxed">
                    Quantum Intelligence partnered with the <strong className="text-red-500 font-medium">Swahilies Business team</strong> to embed data intelligence directly into
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
                  <div className="space-y-3 md:space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">Designing a unified data pipeline across user, subscription, and entire platform data.</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">Implementing real-time analytics for users, revenue, and engagement.</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">Tracking every user click and session to understand true platform usage.</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">Building decision-oriented dashboards for growth and operations teams.</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">Translating raw usage data into clear business actions and engagement activities.</p>
                    </div>
                  </div>

                  <div className="space-y-3 md:space-y-4">
                    <Card className="bg-gradient-to-r from-green-500/10 to-green-600/10 border-green-500/20 hover:shadow-md transition-shadow">
                      <CardContent className="p-3 md:p-4">
                        <h4 className="font-semibold text-green-600 mb-2 text-sm md:text-base">Acquisition</h4>
                        <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">Does the business attract users who become active, paying, and long-term clients?</p>
                      </CardContent>
                    </Card>

                    <Card className="bg-gradient-to-r from-blue-500/10 to-blue-600/10 border-blue-500/20 hover:shadow-md transition-shadow">
                      <CardContent className="p-3 md:p-4">
                        <h4 className="font-semibold text-blue-600 mb-2 text-sm md:text-base">Activation</h4>
                        <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">Do users reach their first meaningful moment of value within the system/product?</p>
                      </CardContent>
                    </Card>

                    <Card className="bg-gradient-to-r from-purple-500/10 to-purple-600/10 border-purple-500/20 hover:shadow-md transition-shadow">
                      <CardContent className="p-3 md:p-4">
                        <h4 className="font-semibold text-purple-600 mb-2 text-sm md:text-base">Engagement</h4>
                        <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">Do people return because the product consistently solves real problems?</p>
                      </CardContent>
                    </Card>

                    <Card className="bg-gradient-to-r from-orange-500/10 to-orange-600/10 border-orange-500/20 hover:shadow-md transition-shadow">
                      <CardContent className="p-3 md:p-4">
                        <h4 className="font-semibold text-orange-600 mb-2 text-sm md:text-base">Retention</h4>
                        <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">Are there early signals of disengagement detected before users leave?</p>
                      </CardContent>
                    </Card>

                    <Card className="bg-gradient-to-r from-red-500/10 to-red-600/10 border-red-500/20 hover:shadow-md transition-shadow">
                      <CardContent className="p-3 md:p-4">
                        <h4 className="font-semibold text-red-600 mb-2 text-sm md:text-base">Revenue</h4>
                        <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">Does usage translate into sustainable revenue growth and trust over time?</p>
                      </CardContent>
                    </Card>
                  </div>
                </div>
