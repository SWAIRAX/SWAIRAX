                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3.5" role="form" aria-label="Project inquiry form">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-[11px]">Full Name<span className="text-destructive">*</span></FormLabel>
                          <FormControl>
                            <Input {...field} placeholder="Enter your full name" className="h-10 rounded-lg bg-background/60 border-border text-sm focus-visible:ring-2 focus-visible:ring-primary/70" aria-required="true" />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-[11px]">Email<span className="text-destructive">*</span></FormLabel>
                          <FormControl>
                            <Input {...field} type="email" placeholder="Enter your email address" className="h-10 rounded-lg bg-background/60 border-border text-sm focus-visible:ring-2 focus-visible:ring-primary/70" aria-required="true" />
                          </FormControl>
                          <FormMessage className="text-xs" />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-[11px]">Phone<span className="text-destructive">*</span></FormLabel>
                          <FormControl>
                            <Input {...field} type="tel" placeholder="+255 XXX XXX XXX" className="h-10 rounded-lg bg-background/60 border-border text-sm focus-visible:ring-2 focus-visible:ring-primary/70" aria-required="true" />
                          </FormControl>
                          <FormMessage className="text-xs" />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-[11px]">Service Needed<span className="text-destructive">*</span></FormLabel>
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            <FormControl>
                              <SelectTrigger
                                aria-required="true"
                                className="h-10 rounded-lg bg-background/60 border-border text-sm focus:ring-0 focus-visible:ring-2 focus-visible:ring-primary/70"
                              >
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-[11px]">Project Description<span className="text-destructive">*</span></FormLabel>
                          <FormControl>
                            <Textarea {...field} placeholder="Tell us about the project, goals, and timelines..." className="min-h-[120px] rounded-lg bg-background/60 border-border text-sm resize-none focus-visible:ring-2 focus-visible:ring-primary/70" aria-required="true" />
                          </FormControl>
                          <FormMessage className="text-xs" />
                        </FormItem>
                      )}
                    ...
                    <Button type="submit" disabled={form.formState.isSubmitting} className="w-full h-10 rounded-lg bg-gradient-to-r from-primary to-primary/80 shadow-lg shadow-primary/30 hover:shadow-primary/50 transition text-sm">
